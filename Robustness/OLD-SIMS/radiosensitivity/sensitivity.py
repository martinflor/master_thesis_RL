...
for idx, dirs in enumerate(list_dir):
    ...
    G1 = float(cc_file[-13][8:12].split()[0].strip())
    S = float(cc_file[-12][12:16].split()[0].strip())
    G2 = float(cc_file[-11][8:12].split()[0].strip())
    M = float(cc_file[-10][10:14].split()[0].strip())
    G0 = float(cc_file[-9][13:17].split()[0].strip())
    TCP = float(cc_file[-5][5:8].split()[0].strip())
    mean_frac, std_frac = float(cc_file[-4][26:31].split()[0].strip()), float(cc_file[-4][41:46].split()[0].strip())
    mean_duration, std_duration = float(cc_file[-3][18:24].split()[0].strip()), float(cc_file[-3][34:40].split()[0].strip())
    mean_survival, std_survival = float(cc_file[-2][18:24].split()[0].strip()), float(cc_file[-2][49:57].split()[0].strip())
    mean_dose, std_dose = float(cc_file[-1][24:29].split()[0].strip()), float(cc_file[-1][39:44].split()[0].strip())
