...
class GridEnv:
    ...
    def __init__(self, reward, h_threshold, c_threshold, sources = 100,
        ...
        self.quiescent_glucose_level = average_healthy_oxygen_consumption*2*24
    ...
    def ccell_state(self, count):
        return min(self.nb_stages_cancer - 1, int(ceil(CancerCell.cell_count / self.state_helper_ccells)))
    ...
    def env_parameters(self):
        ...
        """
        alpha_tumor = cell.alpha_tumor
        beta_tumor = cell.beta_tumor
        alpha_norm_tissue = cell.alpha_norm_tissue
        beta_norm_tissue = cell.beta_norm_tissue
        repair_time = cell.repair_time #
        critical_neighbors = cell.critical_neighbors #
        radiosensitivities = cell.radiosensitivities #
        """
        def latex_float(f):
        ...
        """
        self.params["Gap 1 radiosentitivity"] = radiosensitivities[0]
        self.params["Synthesis radiosentitivity"] = radiosensitivities[1]
        self.params["Gap 2 radiosentitivity"] = radiosensitivities[2]
        self.params["Mitosis radiosentitivity"] = radiosensitivities[3]
        self.params["Quiescence radiosentitivity"] = radiosensitivities[4]
        """
